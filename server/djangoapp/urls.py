...
urlpatterns = [
    ...
    path("get_dealers/", view=get_dealerships, name="dealers"),
    path("get_dealers/<str:state>", view=get_dealerships, name="dealers_by_state"),
    path(
        "get_dealers/<int:dealer_id>",
    ...
    path("", view=add_review, name="add_review"),
